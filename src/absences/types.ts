...
export type Absence = {
  ...
  granted_as_substitute_user_id: number | null;
...
export type AbsenceCreate = Partial<Absence> & Pick<Absence, 'type_id' | 'user_id' | 'from_date' | 'to_date'>;
export type AbsenceUpdate = Partial<Absence> & Pick<Absence, 'id'>;

export type AbsenceApprove = Partial<Absence> & Pick<Absence, 'id'>;
