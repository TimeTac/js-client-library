...
export class AbsenceBansEndpoint extends BaseApi<'absenceBans'> {
  ...
  public create(data: AbsenceBanCreate, params?: RequestParams<Entity<ResourceName>> | string): Required<typeof resourceName> {
    const response = this._post<typeof resourceName>('create', data, { params });
    return requiredSingle(response);
  }

  public update(data: AbsenceBanUpdate, params?: RequestParams<Entity<ResourceName>> | string): Required<typeof resourceName, Resources[typeof resourceName][]> {
