...
export class WorkScheduleDayDefinitionsEndpoint extends BaseApi<ResourceName> {
  ...
  public create(data: WorkScheduleDayDefinitionCreate, params?: RequestParams<Entity<ResourceName>> | string): Required<ResourceName, Entity<ResourceName>[]> {
    const response = this._post<ResourceName>('create', data, { params });
    return required(response);
  }

  public update(data: WorkScheduleDayDefinitionUpdate, params?: RequestParams<Entity<ResourceName>> | string): Required<ResourceName, Entity<ResourceName>[]> {
