...
export class AbsenceTypesEndpoint extends BaseApi<typeof resourceName> {
  ...
  public create(data: AbsenceTypeCreate, params?: RequestParams<Entity<ResourceName>> | string): Required<typeof resourceName, Resources[typeof resourceName][]> {
    const response = this._post<ResourceName>('create', data, { params });
    return required(response);
  }
  public update(data: AbsenceTypeUpdate, params?: RequestParams<Entity<ResourceName>> | string): Required<typeof resourceName, Resources[typeof resourceName][]> {
