...
export type AbsenceType = {
   ...
   */
  absence_subtype_id: number | null;
  /**
   ...
   */
  show_day_amount_config: string | null;
  /**
   ...
   */
  user_limitations_config: string | null;
  /**
   ...
   */
  enable_for_substitute_mode: boolean | null;
  /**
   ...
   */
  restrict_for_country: boolean | null;
  /**
  ...
  individual_value_1: string | null;
  /**
...
export type AbsenceTypesCreate = Pick<AbsenceType, 'name_const' | 'abbreviation_const'>;
export type AbsenceTypesUpdate = Pick<AbsenceType, 'id'>;
