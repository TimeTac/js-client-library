...
import { WorkingHourTemplateHistory } from '../../workingHourTemplateHistory/types';
...
export type Resources = {
  ...
  workingHourTemplateHistory: WorkingHourTemplateHistory;
};
