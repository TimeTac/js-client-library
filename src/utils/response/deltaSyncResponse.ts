...
function convert<T>(deltaSyncResponse: RawApiResponse, resource: keyof DeltaSyncResults): ResourceResponse<T> | undefined {
  // @ts-expect-error unknown type used

  // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
  const includeResponse: RawApiResponse = deltaSyncResponse.Results[resource];
