...
export class NotificationsEndpoint extends BaseApi<ResourceName> {
  ...
  public async update(data: NotificationUpdate[]): Required<typeof resourceName, (ParsedErrorMessage | Notification)[]>;

  public async update(data: NotificationUpdate): Required<ResourceName>;

  public async update(
    data: NotificationUpdate | NotificationUpdate[],
  ): Promise<LibraryReturn<'notifications', Notification> | LibraryReturn<'notifications', (ParsedErrorMessage | Notification)[]>>;
