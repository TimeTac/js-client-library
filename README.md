...
- [x] [notifications](https://api.timetac.com/doc/v3#tag/notifications)
- [x] [notificationsTypeHtml](https://api.timetac.com/doc/v3#tag/notificationsTypeHtml)
- [x] [notificationUrls](https://api.timetac.com/doc/v3#tag/notificationUrls)
...
- [x] [timeTrackingChangelogs](https://api.timetac.com/doc/v3#tag/timeTrackingChangelogs)
...
- [x] [userRoles](https://api.timetac.com/doc/v3#tag/userRoles)
